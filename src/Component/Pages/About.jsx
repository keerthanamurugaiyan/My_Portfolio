...
import MyImg from '../../assets/keerthi.jpg';

const AboutMe = () => {
  return (
    <motion.div
      id="about"
      className="w-full min-h-screen text-black py-20 px-6"
  ...
  <TbBulb className="inline align-middle text-pink-500 text-xl" />"
</p>
  ...
  <span className="text-[#a176c9] font-bold inline-flex items-center gap-1 ml-1">
    Frontend Developer
    <IoLogoReact className="text-[#61DBFB] text-3xl drop-shadow-lg animate-pulse" />
...
<div className="flex gap-4 mt-4">
  ...
  >
    ...
    />
      ...
      {/* <div className="max-w-6xl mx-auto flex flex-col md:flex-row md:gap- items-center gap-">
    ...
    <motion.div className="text-black p-6 md:p-8 rounded-2xl">
      ...
      <div className="flex gap-4 mt-4">
        <motion.a
          ...
          target="_blank"
          rel="noopener noreferrer"
          whileHover={{ scale: 0.97, boxShadow: "0 0 12px rgba(181, 158, 213, 0.6)" }}
          whileTap={{ scale: 0.95, boxShadow: "0 0 8px rgba(181, 158, 213, 0.9)" }}
          className="relative inline-flex items-center gap-2 bg-[#ac94ce] hover:bg-[#a176c9] text-white px-4 py-2 rounded-lg transition-all shadow-md overflow-hidden"
        >
          <span className="relative z-10 flex items-center gap-2">
            <FaLinkedin className="text-xl" /> LinkedIn
